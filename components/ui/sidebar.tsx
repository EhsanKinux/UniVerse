...
function Sidebar({
  ...
  // Below lg the app navigates with the bottom tab bar (see AppShell), so the
  // registry's mobile Sheet branch is intentionally dropped: no drawer, no
  // dependency on the registry Sheet API our custom bottom sheet replaced.
  if (isMobile) {
    return null
  }
