// AUTO-GENERATED from pwa-asset-generator output. iOS launch (startup) images,
// one per device resolution + orientation. Consumed by metadata.appleWebApp.startupImage.
export const appleStartupImages = [
  ...
  {
    "url": "/splash/apple-splash-2340-1080.png",
