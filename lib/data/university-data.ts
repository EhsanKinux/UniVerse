...
export const modulePages = {
  ...
  dormitory: {
    ...
    sectionTitle: "بخش خدمات",
    status: "فعال",
    description: "اطلاعیه‌ها، قوانین، امکانات و فرم‌های خوابگاه دانشجویی، با اعلان‌رسانی اطلاعیه‌های جدید.",
    highlights: ["اطلاعیه با اعلان", "قوانین و امکانات", "فرم‌های موردنیاز"],
    primaryAction: "ورود به خوابگاه",
  },
  "food-week": {
